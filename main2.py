          ...
          if current_touched & pin_bit and not last_touched & pin_bit:
              ...
              if i == PORT_VIDEO_ON_1:
                ...
                if flag_video1 == False:
                  command = "sudo omxplayer --no-osd --loop video/video1.mp4"
              ...
              if i == PORT_VIDEO_ON_2:
                ...
                if flag_video2 == False:
                  command = "sudo omxplayer --no-osd --loop video/sota.mp4"
                  proc = subprocess.Popen(command, shell=True, stdin =subprocess.PIPE)
                  flag_video2 = True 
              ...
              if i == PORT_VIDEO_ON_3:
                ...
                if flag_video3 == False:
                  command = "sudo omxplayer --no-osd --loop video/video3.mp4"
                  proc = subprocess.Popen(command, shell=True, stdin =subprocess.PIPE)
                  flag_video3 = True 
